 ...
 */
final class Version20240717092320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE students DROP classe, DROP regime');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE students ADD classe VARCHAR(255) NOT NULL, ADD regime VARCHAR(255) NOT NULL');
    }
}
